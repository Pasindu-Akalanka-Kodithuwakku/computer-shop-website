...
<body>
    ...
    <!-- sign in -->
        <div class="box-layout">
            <h3 class="title-header">Verify mobile number</h3>
            <form action="/member/sign-in/forgot-password/verify-security-question/" method="post" autocomplete="off">
                <?php
                ...
                <a href="/member/sign-in/"><button type="button">Cancel</button></a>
