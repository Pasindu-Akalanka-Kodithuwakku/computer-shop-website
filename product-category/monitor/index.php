<?php
    ...
    try {
        ...
        header('Location: /product-category/monitor/');
        exit();
    }
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>Dilla's PC - Monitor Stock</title>
...
<body>
    ...
    <main>
        ...
        <div class="category-header" onclick="control_sidebar()"><span>&#9776; Monitor </span><img src="/image/monitor.jpg" alt=""></div>
        <div class="filter-div" id="filter_sidebar">
            <form action="/product-category/monitor/" method="post">
                <fieldset>
                    ...
                    <div class="show-item" id="<?php echo $count; ?>">
                        ...
                        <div class="cart-item">
                            <?php
                                ...
                                ?><a href="/product-category/monitor/?cart=<?php echo $row['productId'] .$getValues .'#' .$count; ?>">Add To Cart <img src="/image/cart.png" alt=""></a><?php # display add to cart option
                            ?>
                        </div>
                    </div>
                    <?php
