<?php
    ...
    try {
        ...
        header('Location: /product-category/laptop/');
        exit();
    }
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>Dilla's PC - Laptop Stock</title>
...
<body>
    ...
    <main>
        ...
        <div class="category-header" onclick="control_sidebar()"><span>&#9776; Laptop </span><img src="/image/laptop.png" alt=""></div>
        <div class="filter-div" id="filter_sidebar">
            <form action="/product-category/laptop/" method="post">
                <fieldset>
                    ...
                    <div class="show-item" id="<?php echo $count; ?>">
                        ...
                        <div class="cart-item">
                            <?php
                                ...
                                ?><a href="/product-category/laptop/?cart=<?php echo $row['productId'] .$getValues .'#' .$count; ?>">Add To Cart <img src="/image/cart.png" alt=""></a><?php # display add to cart option
                            ?>
                        </div>
                    </div>
                    <?php
