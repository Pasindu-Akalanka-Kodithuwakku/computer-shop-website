...
/* set variables */
    $selProductName = $row['productName'];
    $txtProductName = '';
    $selCategory = $row['category'];
    $txtCategory = '';
    $selBrand = $row['brand'];
    $txtBrand = '';
    $selModel = $row['model'];
    ...
    $numQuantity = $row['quantityInStock'];
    $selWarranty = $row['warranty'];
    $txtWarranty = '';
    $selUsedType = $row['usedType'];
...
/* click submit button */
    ...
    /* no errors */
        ...
        /* passes values array to next page */
            ...
            $info["productId"] = $_POST['productId']; # passed product id
            $basicDetails = http_build_query($info); # all data saved in array
        /* progress to next page */
            switch (strtoupper($category)) {
                case "LAPTOP":
                    header("Location: /admin/edit-item/Laptop/?$basicDetails");
                    exit();
                    break;
                case "DESKTOP":
                    header("Location: /admin/edit-item/Desktop/?$basicDetails");
                    exit();
                    break;
                case "MONITOR":
                    header("Location: /admin/edit-item/Monitor/?$basicDetails");
                    exit();
                    break;
                case "MOTHERBOARD":
                    header("Location: /admin/edit-item/Motherboard/?$basicDetails");
                    exit();
                    break;
                case "RAM":
                    header("Location: /admin/edit-item/RAM/?$basicDetails");
                    exit();
                    break;
                case "VGA":
                    header("Location: /admin/edit-item/VGA/?$basicDetails");
                    exit();
                    break;
                case "HDD":
                case "SSD":
                    header("Location: /admin/edit-item/Drive/?$basicDetails");
                    exit();
                    break;
                case "PROCESSOR":
                case "CPU":
                    header("Location: /admin/edit-item/CPU/?$basicDetails");
                    exit();
                    break;
                case "POWER SUPPLY":
                    header("Location: /admin/edit-item/PowerSupply/?$basicDetails");
                    exit();
                    break;
                case "DESKTOP CASE":
                case "CASE":
                    header("Location: /admin/edit-item/DesktopCase/?$basicDetails");
                    exit();
                    break;
                default:
                    header("Location: /admin/edit-item/General/?$basicDetails");
                    exit();
                    break;
            }
        }
...
<body>
    ...
    <!-- add new items -->
        <div class="box-layout">
            ...
            <form action="/admin/edit-item/" method="post" enctype="multipart/form-data" autocomplete="off">
                <?php
            ...
            <!-- done & cancel btn -->
                <a href="/admin/manage-item/"><button type="button">Cancel</button></a>
