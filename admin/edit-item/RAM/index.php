...
/* set variables */
    ...
    $txtMemoryType = '';
    $selCompatibleType = $specification[2];
...
<body>
    ...
    <!-- add new items -->
        <div class="box-layout">
            ...
            <form action="/admin/edit-item/RAM/" method="post" enctype="multipart/form-data" autocomplete="off">
                <?php
            ...
            <!-- memory type -->
                ...
                <!-- enter new memory type -->
                    <input type="text" name="txtMemoryType" placeholder="Enter new RAM capacity (Ex: Memory Type: 32GB)" value="<?php echo $txtMemoryType; ?>" maxlength="20">
                </fieldset>
                <p class="custom-note">Please enter 1 to 20 characters</p>
            <!-- Compatible type -->
