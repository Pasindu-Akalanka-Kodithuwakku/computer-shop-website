...
/* check is valid product id */
    ...
    if (!(isset($_REQUEST['category']) && (strtoupper($_REQUEST['category']) == "DESKTOP CASE" || strtoupper($_REQUEST['category']) == "CASE"))) {
...
/* click submit button */
    ...
    /* check errors */
        if ($selCaseType == "none") {
            $info[] = "Desktop case type field is required. ⁉️"; # case type field not fill error
        }
    ...
    /* no errors */
        if (empty($info)) {
        /* join specification */
            $specification = array($selCaseType);
...
<body>
    ...
    <!-- add new items -->
        <div class="box-layout">
            ...
            <form action="/admin/edit-item/DesktopCase/" method="post" enctype="multipart/form-data" autocomplete="off">
                <?php
            ...
            <!-- desktop case type -->
                <h3 class="sub-header">Desktop Case Type *</h3>
                <select name="selCaseType">
                    <option value="none">-- Not selected --</option>
                    <option value="Casing Type: Gaming" <?php echo $selCaseType == "Casing Type: Gaming" ? "selected" : '' ; ?>>Gaming Case</option>
                    <option value="Casing Type: Normal" <?php echo $selCaseType == "Casing Type: Normal" ? "selected" : '' ; ?>>Normal Case</option>
                </select>
                <p class="custom-note">Select one of the above</p>
            <!-- description -->
                <h3 class="sub-header">Description (Optional)</h3>
                <textarea name="rtxtDescription" placeholder="Enter description (Ex: Fan System: RGB, etc..)" maxlength="1500"><?php echo $rtxtDescription; ?></textarea>
