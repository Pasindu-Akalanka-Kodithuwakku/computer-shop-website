...
<body>
    ...
    <!-- add new items -->
        <div class="box-layout">
            ...
            <form action="/admin/add-item/Drive/" method="post" enctype="multipart/form-data" autocomplete="off">
                <?php
            ...
            <!-- capacity -->
                ...
                <fieldset style="margin-bottom: 0;">
                    ...
                    <p>Or</p>
                <!-- enter new capacity -->
                    <input type="text" name="txtCapacity" placeholder="Enter new Drive capacity (Ex: Capacity: 250GB)" value="<?php echo $txtCapacity; ?>" maxlength="30">
                </fieldset>
            ...
            <!-- description -->
                ...
                <textarea name="rtxtDescription" placeholder="Enter description (Ex: Read Speed: 1Gbps, etc..)" maxlength="1500"><?php echo $rtxtDescription; ?></textarea>
