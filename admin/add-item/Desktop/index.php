...
<body>
    ...
    <!-- add new items -->
        <div class="box-layout">
            ...
            <form action="/admin/add-item/Desktop/" method="post" enctype="multipart/form-data" autocomplete="off">
                <?php
            ...
            <!-- graphics -->
                ...
                <fieldset style="margin-bottom: 0;">
                    ...
                    <p>Or</p>
                <!-- enter new graphic -->
                    <input type="text" name="txtGraphic" placeholder="Enter new graphic by (Ex: Intel HD Graphics)" value="<?php echo $txtGraphic; ?>" maxlength="50">
                </fieldset>
                <p class="custom-note">Please enter 1 to 50 characters</p>
            <!-- motherboard -->
