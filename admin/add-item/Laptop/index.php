...
<body>
    ...
    <!-- add new items -->
        <div class="box-layout">
            ...
            <form action="/admin/add-item/Laptop/" method="post" enctype="multipart/form-data" autocomplete="off">
                <?php
            ...
            <!-- operating system -->
                ...
                <!-- enter new operating system -->
                    <input type="text" name="txtOperatingSystem" placeholder="Enter new operating system (Ex: Operating System: Windows 11 Home Single Language)" value="<?php echo $txtOperatingSystem; ?>" maxlength="50">
                </fieldset>
                <p class="custom-note">Please enter 1 to 50 characters</p>
            <!-- description -->
