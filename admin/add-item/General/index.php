...
<body>
    ...
    <!-- add new items -->
        <div class="box-layout">
            ...
            <form action="/admin/add-item/General/" method="post" enctype="multipart/form-data" autocomplete="off">
                <?php
            ...
            <!-- description -->
                ...
                <textarea name="rtxtDescription" placeholder="Enter description" maxlength="1500"><?php echo $rtxtDescription; ?></textarea>
